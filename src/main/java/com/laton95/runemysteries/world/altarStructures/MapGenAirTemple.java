...
public class MapGenAirTemple extends MapGenStructure {
	private final List<Biome.SpawnListEntry> runeAltarSpawnList;

	public MapGenAirTemple(World world) {
		this.world = world;
	...
	protected StructureStart getStructureStart(int chunkX, int chunkZ) {
		return new MapGenAirTemple.Start(this.world, this.rand, chunkX, chunkZ);
	}

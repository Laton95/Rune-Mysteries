...
public class RuinTracker
{
	...
	{
		BlockPos pos = null;
		int maxRange = ModConfig.WORLD_GENERATION.rune_altars.maxRuneAltarRange;
		int minRange = ModConfig.WORLD_GENERATION.rune_altars.minRuneAltarRange;
		int tries = ModConfig.WORLD_GENERATION.rune_altars.runeAltarTries;

...
public class ChunkGeneratorFire implements IChunkGenerator {
	...
	protected static final IBlockState SURFACEBLOCK = Blocks.GRAVEL.getDefaultState();
	protected static final IBlockState OCEANBLOCK = Blocks.LAVA.getDefaultState();

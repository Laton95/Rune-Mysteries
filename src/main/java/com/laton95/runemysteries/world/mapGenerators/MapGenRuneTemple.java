...
public class MapGenRuneTemple extends MapGenStructure
{
	...
	{
		if (chunkX == 0 && chunkZ == 0 || chunkX == -1 && chunkZ == 0 || chunkX == 0 && chunkZ == -1
				|| chunkX == -1 && chunkZ == -1)
		{
			return true;
		}
	...
	public static class Start extends StructureStart
	{
		...
		public Start(World worldIn, Random random, int chunkX, int chunkZ, Biome biomeIn)
		{
			...
			{
				ComponentTemple componentAirTemple = new ComponentTemple(chunkX, chunkZ, "air",
						new BlockPos(-5, 87, -6), 63);
				components.add(componentAirTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.bloodTempleDimID)
			{
				ComponentTemple componentBloodTemple = new ComponentTemple(chunkX, chunkZ, "blood",
						new BlockPos(-7, 86, 6), 84);
				components.add(componentBloodTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.bodyTempleDimID)
			{
				ComponentTemple componentBodyTemple = new ComponentTemple(chunkX, chunkZ, "body",
						new BlockPos(7, 87, 3), 86);
				components.add(componentBodyTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.chaosTempleDimID)
			{
				ComponentTemple componentChaosTemple = new ComponentTemple(chunkX, chunkZ, "chaos",
						new BlockPos(3, 86, -3), 86);
				components.add(componentChaosTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.deathTempleDimID)
			{
				ComponentTemple componentDeathTemple = new ComponentTemple(chunkX, chunkZ, "death",
						new BlockPos(3, 86, 6), 84);
				components.add(componentDeathTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.earthTempleDimID)
			{
				ComponentTemple componentEarthTemple = new ComponentTemple(chunkX, chunkZ, "earth",
						new BlockPos(9, 87, 0), 86);
				components.add(componentEarthTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.fireTempleDimID)
			{
				ComponentTemple componentFireTemple = new ComponentTemple(chunkX, chunkZ, "fire",
						new BlockPos(0, 86, -9), 83);
				components.add(componentFireTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.lawTempleDimID)
			{
				ComponentTemple componentLawTemple = new ComponentTemple(chunkX, chunkZ, "law", new BlockPos(5, 87, -6),
						86);
				components.add(componentLawTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.mindTempleDimID)
			{
				ComponentTemple componentMindTemple = new ComponentTemple(chunkX, chunkZ, "mind",
						new BlockPos(-4, 87, -1), 86);
				components.add(componentMindTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.natureTempleDimID)
			{
				ComponentTemple componentNatureTemple = new ComponentTemple(chunkX, chunkZ, "nature",
						new BlockPos(-7, 86, -6), 84);
				components.add(componentNatureTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.soulTempleDimID)
			{
				ComponentTemple componentSoulTemple = new ComponentTemple(chunkX, chunkZ, "soul",
						new BlockPos(-12, 86, 0), 80);
				components.add(componentSoulTemple);
			}
			else if (dimensionID == ModConfig.DIMENSIONS.waterTempleDimID)
			{
				ComponentTemple componentWaterTemple = new ComponentTemple(chunkX, chunkZ, "water",
						new BlockPos(0, 86, -9), 83);

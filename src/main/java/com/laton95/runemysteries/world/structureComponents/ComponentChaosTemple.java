...
public class ComponentChaosTemple extends WorldHelper.ModFeature {

	public ComponentChaosTemple() {
	}

	public ComponentChaosTemple(Random rand, int x, int z) {
		super(rand, x, 84, z, 8, 4, 8);
	}
	...
	public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn) {
		...
		Template temple = WorldHelper.getTemplate(worldIn, "chaos_temple");
		...
		worldIn.setBlockState(new BlockPos(3, 86, -3), BlockRegistry.ALTAR_PORTAL.getDefaultState());
		return true;
	}
}
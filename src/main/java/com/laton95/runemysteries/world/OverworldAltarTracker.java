...
public class OverworldAltarTracker extends AltarTracker {
	public OverworldAltarTracker(World world) {
		...
		runeAltars.add(new RuneAltar("soul_altar", defaultAltarRadius, defaultAltarFlatnessTolerance,
				WorldGenReference.soulAltarBiomes, WorldGenReference.soulAltarBiomesN, Type.SOUL, "soul_altar_room",0));
		...
		runeAltars.add(new RuneAltar("ourania_altar", defaultAltarRadius, 0f,
				WorldGenReference.ouraniaAltarBiomes, WorldGenReference.ouraniaAltarBiomesN, Type.UNDERGROUND, "ourania_altar_room",2));
	}
}

...
public class WaterTempleDimension extends RuneTempleDimension {
	...
	public ChunkGenerator<?> createChunkGenerator() {
		return ModChunkGenerators.SURFACE_WORLD.create(world, ModBiomeProviders.WATER_TEMPLE.create(ModBiomeProviders.WATER_TEMPLE.createSettings()), ModChunkGenerators.SURFACE_WORLD.createSettings());
	}

...
public class BodyTempleDimension extends RuneTempleDimension {
	
	public BodyTempleDimension(World world, DimensionType type) {
		super(world, type, EnumRuneType.BODY);
	}
	...
	public ChunkGenerator<?> createChunkGenerator() {
		...
		return new SolidWorldChunkGenerator(world, new RuneTempleBiomeProvider(world.getWorldInfo(), ModBiomes.BODY_TEMPLE), settings);
	}

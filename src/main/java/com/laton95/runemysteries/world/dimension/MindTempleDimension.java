...
public class MindTempleDimension extends RuneTempleDimension {
	
	public MindTempleDimension(World world, DimensionType type) {
		super(world, type, EnumRuneType.MIND);
	}

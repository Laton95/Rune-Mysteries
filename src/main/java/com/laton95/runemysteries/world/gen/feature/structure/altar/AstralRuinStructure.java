...
public class AstralRuinStructure extends Structure<NoFeatureConfig> {
	...
	public boolean hasStartAt(ChunkGenerator<?> chunkGen, Random rand, int chunkPosX, int chunkPosZ) {
		return RuneMysteries.ruinManager.isRuinInChunk(EnumRuneType.ASTRAL, chunkGen, new ChunkPos(chunkPosX, chunkPosZ));
	}
	...
	public BlockPos findNearest(World world, ChunkGenerator<? extends GenerationSettings> chunkGenerator, BlockPos pos, int radius, boolean p_211405_5_) {
		return RuneMysteries.ruinManager.getRuinPosition(EnumRuneType.ASTRAL, chunkGenerator);
	}
	...
	public class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
			...
			SurfaceRuinPieces.addPieces(templateManager, pos, this.components, ASTRAL_RUIN, SurfaceRuinPieces.DIRT_ISLAND, EnumRuneType.ASTRAL);

...
import com.laton95.runemysteries.world.chunkGenerators.ChunkGeneratorLaw;
...
public class LawDimension extends WorldProvider {
	/**
	...
	public IChunkGenerator createChunkGenerator() {
		return new ChunkGeneratorLaw(world, world.getSeed());
	}
}
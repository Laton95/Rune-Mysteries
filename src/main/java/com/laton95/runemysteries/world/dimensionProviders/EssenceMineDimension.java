...
import com.laton95.runemysteries.world.chunkGenerators.ChunkGeneratorEssenceMine;
...
public class EssenceMineDimension extends WorldProvider
{
	...
	{
		return new ChunkGeneratorEssenceMine(world, world.getSeed());
	}
	...
	{
		return ModDimensions.ESSENCEMINE;
	}
}

...
public final class LootRegistry
{
	...
	public static final ResourceLocation OURANIA_ALTAR = LootTableList.register(
			new ResourceLocation(ModReference.MOD_ID, "altars/ourania_altar"));
	...
	private LootPool getInjectPool(String entryName)
	{
		return new LootPool(new LootEntry[] {
				getInjectEntry(entryName,
						1) }, new LootCondition[0], new RandomValueRange(1), new RandomValueRange(0, 1), "runemysteries_inject_pool");
	}

	private LootEntryTable getInjectEntry(String name, int weight)
	{
		return new LootEntryTable(new ResourceLocation(ModReference.MOD_ID, "inject/"
				+ name), weight, 0, new LootCondition[0], "runemysteries_inject_entry");
	}
}

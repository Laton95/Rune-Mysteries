...
public class ModWorldGen
{
	...
	public static void registerWorldGen()
	{
		...
		StructureEntry[] structures = {new InitDataStructures().new StructureEntry("RuneAltar_SURFACE", MapGenRuneAltar_SURFACE.Start.class),
		...
		ComponentEntry[] components = {new InitDataStructures().new ComponentEntry("SurfaceAltar", ComponentSurfaceAltar.class),

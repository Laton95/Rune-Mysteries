...
public class VillagerRegistry
{
	...
	{
		net.minecraftforge.fml.common.registry.VillagerRegistry.instance().registerVillageCreationHandler(new VillageWizardsHouse.VillageManager());
		...
		career_Runecrafter.addTrade(1, new VillagerTradeHelper.Trade(Items.EMERALD, new PriceInfo(1, 2), 0, ItemRegistry.MINE_SCROLL, new PriceInfo(2, 4), 0));
		career_Runecrafter.addTrade(2, new VillagerTradeHelper.Trade(ItemRegistry.RUNE_TALISMAN, new PriceInfo(1, 1), 13, Items.EMERALD, new PriceInfo(3, 6), 0));
		career_Runecrafter.addTrade(3, new VillagerTradeHelper.Trade(Items.EMERALD, new PriceInfo(8, 12), 0, ItemRegistry.RUNE_TALISMAN, new PriceInfo(1, 1), 13));
	}
}

...
import com.laton95.runemysteries.world.gen.*;
...
public class ModChunkGenerators {
	...
	public static void registerChunkGenerators(RegistryEvent.Register<ChunkGeneratorType<?, ?>> event) {
		event.getRegistry().register(new ChunkGeneratorType<>(SurfaceWorldChunkGenerator::new, false, SurfaceGenerationSettings::new).setRegistryName(RuneMysteries.MOD_ID, "surface_world"));

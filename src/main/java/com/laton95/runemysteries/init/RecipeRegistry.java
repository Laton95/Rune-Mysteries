...
public class RecipeRegistry {
	...
	private static void makeRecipeList() {
		...
		recipeMap.put("Flesh block", new ResourceLocation(ModReference.MOD_ID + ":flesh_block.json"));
		recipeMap.put("Temple block stairs", new ResourceLocation(ModReference.MOD_ID + ":temple_block_stairs.json"));
		recipeMap.put("Blood block stairs", new ResourceLocation(ModReference.MOD_ID + ":blood_block_stairs.json"));
		recipeMap.put("Temple block slab", new ResourceLocation(ModReference.MOD_ID + ":temple_block_slab.json"));
		recipeMap.put("Blood block slab", new ResourceLocation(ModReference.MOD_ID + ":blood_block_slab.json"));

...
public class BlockRailGate extends BlockHorizontal{
    ...
    public BlockRailGate(String name, Material material, float hardness, Float resistance, String toolClass,
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        return connector instanceof BlockFence || connector instanceof BlockWall  || connector instanceof BlockRail;
    }

...
public class ItemRune extends RMModItem
{
	...
	{
		AIR("air", 0), ASTRAL("astral", 1), BLOOD("blood", 2), BODY("body", 3), CHAOS("chaos", 4), COSMIC("cosmic",
				5), DEATH("death", 6), EARTH("earth", 7), FIRE("fire",
						8), LAW("law", 9), MIND("mind", 10), NATURE("nature", 11), SOUL("soul", 12), WATER("water", 13);

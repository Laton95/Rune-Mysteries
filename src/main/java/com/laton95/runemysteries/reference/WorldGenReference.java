...
public class WorldGenReference
{
	...
	public static final List<BiomeDictionary.Type> MIND_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);

	public static final List<BiomeDictionary.Type> NATURE_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.JUNGLE);
	public static final List<BiomeDictionary.Type> NATURE_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);
	...
	public static final List<BiomeDictionary.Type> WATER_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);

	public static final List<BiomeDictionary.Type> COSMIC_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.END);
	public static final List<BiomeDictionary.Type> COSMIC_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);

	public static final List<BiomeDictionary.Type> CHAOS_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.NETHER);
	public static final List<BiomeDictionary.Type> CHAOS_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);

	public static final List<BiomeDictionary.Type> OURANIA_ALTAR_BIOMES = ImmutableList.of();
	public static final List<BiomeDictionary.Type> OURANIA_ALTAR_BIOMES_AVOID = ImmutableList
			.of(BiomeDictionary.Type.OCEAN);
}

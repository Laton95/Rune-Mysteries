...
public class WorldGenReference
{
	...
	public static final List<BiomeDictionary.Type> AIR_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.MESA, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.PLAINS);
	
	public static final List<BiomeDictionary.Type> AIR_ALTAR_BIOMES_AVOID = ImmutableList.of(BiomeDictionary.Type.OCEAN);
	
	public static final List<BiomeDictionary.Type> ASTRAL_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.MUSHROOM, BiomeDictionary.Type.SNOWY);
	...
	public static final List<BiomeDictionary.Type> BODY_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.CONIFEROUS, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.PLAINS);
	...
	public static final List<BiomeDictionary.Type> EARTH_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.SAVANNA, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.PLAINS);
	...
	public static final List<BiomeDictionary.Type> LAW_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.FOREST, BiomeDictionary.Type.PLAINS);
	
	public static final List<BiomeDictionary.Type> LAW_ALTAR_BIOMES_AVOID = ImmutableList.of(BiomeDictionary.Type.OCEAN);
	
	public static final List<BiomeDictionary.Type> MIND_ALTAR_BIOMES = ImmutableList.of(BiomeDictionary.Type.PLAINS, BiomeDictionary.Type.DEAD, BiomeDictionary.Type.WASTELAND);
	...
	public static final List<BiomeDictionary.Type> SOUL_ALTAR_BIOMES_AVOID = ImmutableList.of(BiomeDictionary.Type.MESA, BiomeDictionary.Type.OCEAN);
